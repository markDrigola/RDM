    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function addVerticalNavigation(){
            ...
            $(SECTION_NAV_SEL).find('li').eq($(SECTION_ACTIVE_SEL).index(SECTION_SEL)).find('a').addClass(ACTIVE).parent("li").addClass('active-li');
        }
        ...
        */
        function activateNavDots(name, sectionIndex){
            if(options.navigation){
                $(SECTION_NAV_SEL).find(ACTIVE_SEL).removeClass(ACTIVE).parent("li").removeClass('active-li');
                if(name){
                    $(SECTION_NAV_SEL).find('a[href="#' + name + '"]').addClass(ACTIVE).parent("li").addClass('active-li');
                }else{
                    $(SECTION_NAV_SEL).find('li').eq(sectionIndex).find('a').addClass(ACTIVE).parent("li").addClass('active-li');
                }
            }
        }
